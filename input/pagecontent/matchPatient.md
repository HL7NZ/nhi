...
<td> Resource </td>
<td> Mandatory </td>
<td> <a href="matchExample.html">$match request Patient resource examples</a> <br /> The match patient resource uses the following attributes in the $match request 
<ul>
