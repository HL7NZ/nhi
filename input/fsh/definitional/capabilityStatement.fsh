...
* rest.resource.interaction.documentation = "Used to retrieve a Patient resource by Id. <br /> HTTP Request 'GET' <br /> Scope required: patient:read / Patient.r"
...
* rest.resource.operation.documentation = "**$Match (Find NHI)** with In parameter onlyCertainMatches: 0 (False) An operation to search the NHI by demographics using fuzzy logic. Returns a bundle of results with match scores. <br /> HTTP Request 'POST' <br /> Scope required: patient:search / Patient.s <br /> **$Match (Validate)** with In parameter onlyCertainMatches: 1 (True) An operation to validate known patient demographic details against an NHI number. Returns a bundle of results with one patient resource that includes the live nhi-id <br /> HTTP Request 'POST' <br /> Scope required: patient:validate / Patient.v"
...
* rest.resource.operation[1].documentation = "An operation to set the patient.name.preferred boolean to True. <br /> HTTP Request 'POST' <br /> Scope required: patient:write / Patient.u"
...
* rest.resource.operation[2].documentation = "Allows a user to replace a physical address OR add or replace a postal address with an eSAM validated address <br /> HTTP Request 'POST' <br /> Scope required: patient:write / Patient.u" 
...
* rest.resource.operation[3].documentation = "Allows a user to replace a physical address OR add or replace a postal address with an unvalidated address<br /> HTTP Request 'POST' <br /> Scope required: patient:write / Patient.u" 
...
* rest.resource.operation[4].documentation = "Allows a user to remove a postal address from the nhi record <br /> HTTP Request 'POST' <br /> Scope required: patient:write / Patient.u" 
