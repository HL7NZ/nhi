...
* rest.resource.interaction.documentation = "HTTP Request 'GET' <br /> Used to retrieve a Patient resource by Id."
...
* rest.resource.operation.documentation = "HTTP Request 'POST' <br /> $Match (Find NHI) with In parameter onlyCertainMatches: 0 (False) An operation to search the NHI by demographics using fuzzy logic. Returns a bundle of results with match scores. <br /> $Match (Validate) with In parameter onlyCertainMatches: 1 (True) An operation to validate known patient demographic details against an NHI number. Returns a bundle of results with one patient resource that includes the live nhi-id"
...
* rest.resource.operation[1].documentation = "HTTP Request 'POST' <br /> An operation to set the patient.name.preferred boolean to True." 
...
* rest.resource.operation[2].documentation = "HTTP Request 'POST' <br /> Allows a user to replace a physical address OR add or replace a postal address with an eSAM validated address" 
...
* rest.resource.operation[3].documentation = "HTTP Request 'POST' <br />Allows a user to replace a physical address OR add or replace a postal address with an unvalidated address" 
...
* rest.resource.operation[4].documentation = "HTTP Request 'POST' <br /> Allows a user to remove a postal address from the nhi record" 
