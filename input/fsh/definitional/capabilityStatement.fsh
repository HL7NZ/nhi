...
* rest.resource.operation[1].documentation = "POST, [base]/Patient/$set-preferred-name, An operation to set the patient.name.preferred boolean to True., patient:write / Patient.u"
...
* rest.resource.operation[2].documentation = "POST, [base]/Patient/$set-address, Allows a user to replace a physical address OR add or replace a postal address with an eSAM validated address., patient:write / Patient.u" 
...
* rest.resource.operation[3].documentation = "POST, [base]/Patient/$set-unvalidated-address, Allows a user to replace a physical address OR add or replace a postal address with an unvalidated address., patient:write / Patient.u" 
...
* rest.resource.operation[4].documentation = "POST, [base]/Patient/$remove-postal-address, Allows a user to remove a postal address from the nhi record.,  patient:write / Patient.u" 
...
* rest.resource.operation[5].documentation = "POST, [base]/Patient/$update-birth, An operation to update a patient's birth details., system/Patient.u, system/Patient.a" 
...
* rest.resource.operation[6].documentation = "POST, [base]/Patient/$update-identity, An operation to update a patient's identity details., system/Patient.u, system/Patient.a" 
...
* rest.resource.operation[7].documentation = "POST, [base]/Patient/$add-name, An operation to add a name to a patient's NHI record., system/Patient.u, system/Patient.a" 
...
* rest.resource.operation[9].documentation = "POST, [base]/Patient/$inactivate-name, An operation to replace a name on a patient's record. ,system/Patient.u, system/Patient.a" 
...
* rest.resource.operation[10].documentation = "POST, [base]/Patient/$update-eligibility, An operation to replace a name on a patient's record., system/Patient.u, system/Patient.a" 

* rest.resource.operation[11].name = "create-patient"
...
// * rest.resource.operation[11].documentation = "POST, [base]/Patient/$update-death, An operation to update a patient's death details., system/Patient.u, system/Patient.a" 
