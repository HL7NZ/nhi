...
* rest.resource.operation[1].documentation = "POST, [base]/Patient/$set-preferred-name, Set the patient's preferred name, system/Patient.u"
...
* rest.resource.operation[2].documentation = "POST, [base]/Patient/$set-address,Update a patient's address, system/Patient.u" 
...
* rest.resource.operation[4].documentation = "POST, [base]/Patient/$remove-postal-address, Remove a patient's postal address,system/Patient.u" 
...
* rest.resource.operation[7].documentation = "POST, [base]/Patient/$add-name, Add a name to a patient's NHI record, system/Patient.u, system/Patient.a" 
...
* rest.resource.operation[9].documentation = "POST, [base]/Patient/$inactivate-name, Inactivate a name that is currently active on a patients record ,system/Patient.u, system/Patient.a" 
...
* rest.resource.operation[10].documentation = "POST, [base]/Patient/$update-eligibility, Update a patient's citizenship information, system/Patient.u, system/Patient.a" 
...
* rest.resource.operation[11].documentation = "POST, [base]/Patient/$create,Create a new patient record in the NHI, system/Patient.c, system/Patient.a" 
