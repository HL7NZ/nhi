...
Alias: $dhb-code-cs = https://nzhts.digital.health.nz/ns/dhb-code
Alias: $pho-code-cs = https://nzhts.digital.health.nz/ns/pho-code
Alias: $domicile-code-cs = https://nzhts.digital.health.nz/ns/domicile-code
Alias: $funded-programme-cs = https://nzhts.digital.health.nz/ns/funded-programme-code
Alias: $information-source-cs = https://nzhts.digital.health.nz/ns/information-source-code
Alias: $nz-residency-status-cs = https://nzhts.digital.health.nz/ns/nz-residency-status-code
Alias: $citizenship-status-cs = https://nzhts.digital.health.nz/ns/nz-citizenship-status-code
Alias: $ethnicity-code-cs = https://nzhts.digital.health.nz/ns/ethnic-group-level-4-code
Alias: $condition-on-practice-cs = https://nzhts.digital.health.nz/ns/condition-on-practice-code
Alias: $alias-type-cs = https://nzhts.digital.health.nz/ns/alias-type-code
Alias: $pr-status-reason-cs = https://nzhts.digital.health.nz/ns/hpi-practitioner-role-status-reason-code
Alias: $name-prefix-cs = https://nzhts.digital.health.nz/ns/name-prefix-code
Alias: $name-suffix-cs = https://nzhts.digital.health.nz/ns/name-suffix-code
Alias: $country-code-cs = https://nzhts.digital.health.nz/ns/country-code
Alias: $dhb-cs = https://nzhts.digital.health.nz/ns/dhb-code
Alias: $datum-cs = https://nzhts.digital.health.nz/ns/datum-code
Alias: $nz-additional-sex-code = https://nzhts.digital.health.nz/ns/nz-additional-sex-code
Alias: $address-not-validated-reason-code = https://nzhts.digital.health.nz/ns/address-not-validated-reason-code
