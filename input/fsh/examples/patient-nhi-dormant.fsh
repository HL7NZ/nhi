...
* extension[=].valueCodeableConcept.coding = $ethnic-group-level-4-code#51113 "Assyrian"
* extension[=].valueCodeableConcept.text = "Assyrian"
* extension[+].url = "http://hl7.org.nz/fhir/StructureDefinition/nz-ethnicity"
* extension[=].valueCodeableConcept.coding.version = "2.0"
* extension[=].valueCodeableConcept.coding = $ethnic-group-level-4-code#12913 "Austrian"
...
* deceasedDateTime.extension.valueCodeableConcept.coding = $information-source-code#MCCOD "Medical Certificate Cause of Death"
* deceasedDateTime.extension.valueCodeableConcept.text = "Medical Certificate Cause of Death"
* address.id = "27"
...
* address.extension[=].valueCodeableConcept.coding = $address-not-validated-reason-code#OTHER "Other"
...
* address.extension[=].valueCodeableConcept = $domicile-code#2125 "Willis Street-Cambridge Terrace"
