...
* extension[+].url = "http://hl7.org.nz/fhir/StructureDefinition/nhi-contact"
* extension[=].extension[+].url = "isVerified"
* extension[=].extension[=].valueBoolean = true
* extension[=].extension[+].url = "isPrivate"
* extension[=].extension[=].valueBoolean = true
...
Instance: Inline-Instance-for-ZKC4633-2
