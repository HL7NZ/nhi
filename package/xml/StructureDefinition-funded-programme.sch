...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'fundedProgramme']) &lt;= 1">extension with URL = 'fundedProgramme': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'currentAvailability']) &lt;= 1">extension with URL = 'currentAvailability': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'notes']) &lt;= 1">extension with URL = 'notes': maximum cardinality of 'extension' is 1</sch:assert>
