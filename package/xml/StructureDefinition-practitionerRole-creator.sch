...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'person']) &gt;= 1">extension with URL = 'person': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'person']) &lt;= 1">extension with URL = 'person': maximum cardinality of 'extension' is 1</sch:assert>
